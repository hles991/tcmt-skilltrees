...
const tcm__perkData = [
	...
	[25,"clear eyes","stealth","Clears up your vision to help identify poisoned objects, traps, and locks set by The Cook. Range is 20 meters.",[1,4]],
	[26,"cover recovery","stealth","Stamina recovery increased by 120% while using hiding spots or shadows.",[2,4]],
	[27,"fuse lights","stealth","When the fuse box is turned on or off, all Family members and the fuse box are highlighted for 90 seconds.",[4,4]],
	...
	[31,"overlooked","stealth","When Grandpa's Sonar ability is active, you will remain undetected even if you are spotted. Has 5 charges.",[0,5]],
	[32,"parting gift","stealth","When another Victim escapes, all Family members are highlighted to the perk holder for 120 seconds.",[1,5]],
	[33,"rally leader","stealth","Help all Victims recover from being incapacitated more quickly. Recovery is 40% faster.",[3,5]],
	...
	[35,"sanguine shadow","stealth","If you drop below 70% health, it can be refilled slowly by staying hidden and motionless in shadows or hiding spots. Health received is 2.5HP per second up to a maximum of 70% of your total health.",[4,5]],
	...
	[38,"spotter","stealth","If a Family member moves within close proximity to where you are currently hiding, they will be highlighted for all Victims to see. Highlight range is 8 meters.",[8,5]],
	...
	[44,"let's stick together","strength","While all Victims are alive and before any have escaped, your bleedout is reduced by 75%.",[6,6]],
	...
	[50,"tae kwon door","strength","Slamming doors on Family members will stun the target for 5 seconds.",[3,7]],
	
	[51,"am i bleeding","toughness","When your health is below 60%, you are highlighted to all fellow Victims.",[5,7]],
	...
	[54,"full hearts","toughness","While below 30% health, all healing items are highlighted.",[9,7]],
	...
	[62,"conditioned","endurance","Stamina consumption on sprinting is reduced by 50%.",[3,0]],
	...
	[65,"empowered","endurance","After surviving a close encounter, you regain 100% stamina.",[5,0]],
	...
	[68,"high tolerance","endurance","Sissy's poison isn't as effective on you. Duration is 70% shorter.",[9,0]],
	...
	[74,"slippery","endurance","After navigating gaps or crawl spaces, you move 15% faster for 10 seconds.",[9,1]],
	[75,"well trained","endurance","After jumping down a well, all healing items, bone scrap and unlock tools within 30 meters are highlighted for 60 seconds.",[1,2]],
	...
	[77,"i can make it","endurance","When under 30% health, speed is increased by 10%.",[0,1]],
	...
	[79,"resilient","toughness","Bleedout is reduced by 50%",[7,8]],
	...
	[82,"quick exit","proficiency","If a Family member is within 10 meters, crawl spaces can be opened with 1 button tap. Traversing crawl spaces is 30% faster.",[6,3]],
	...
	[86,"protective aura","unique","While above 80% health, Victims within 15 meters take 50% less damage.",[9,9]],
	...
	[91,"bloodar","unique","Tainted blood buckets also highlight any Family member who comes near them within a range of 15 meters for the duration they are tainted.",[4,9]],
	...
	[93,"artful dodger","endurance","When within 10 meters of a Family member, nearby crawl spaces open in 1 button tap. Traversing crawl spaces is 30% faster.",[0,0]],
	...
	[96,"final girl","unique","When you are the last victim alive, increase your maximum stamina by 30%. Shards from sneak attacks do not break (includes Grandpa).",[2,7]],
	...
	[111,"no stopping","endurance","If the valve or basement exits are opened, or the electric cattle grid is disabled, your stamina depletion will be reduced by 50%.",[5,1]],
	...
	[115,"versatile","unique","If at least one throwing knife is in Wyatt's inventory, bone chimes can be cut down, and does not consume a knife. Cutting down bone charms is 80% faster, whether they are cut down by a throwing knife or a bone shard.",[3,10]],
	[116,"awareness","unique","Reveals the Family members hit by a throwing knife only to Wyatt for 60 seconds.",[5,10]],
	[117,"blind spot","unique","Hitting Grandpa with a throwing knife makes Wyatt undetectable by him for his next scream. Also, the amount of Grandpa's blood is reduced by 60.",[2,10]],

	/*family perks*/
	[200,"activated","savagery","After being stunned, you deal 25% extra damage for 40 seconds.",[8,2]],
	[201,"battering ram","savagery","When barging a door, instantly barge through with 1 hit.",[9,2]],
	...
	[209,"you'll pay for that!","savagery","If Grandpa is incapacitated, your damage dealt to Victims is increased by 30% until he recovers.",[7,3]],
	...
	[213,"i'll find ya","blood-harvest","Family Focus ability duration is increased by 250% and the cooldown is reduced by 30%.",[4,0]],
	...
	[226,"i smell blood","endurance","Your proximity range is increased by 5X to help you stay focused on the last Victim.",[8,1]],
	[227,"quick operator","endurance","After interacting, the generator and fuse have a 60 seconds longer cooldown. The generator starts with only 1 pull.",[9,1]],
	...
	[234,"quarterback","unique","Leatherface can knock Victims down with the chainsaw, even if it is turned off. Cooldown is 30 seconds.",[8,3]],
	[239,"master key","unique","You can instantly burst through a latched door 5 times.",[0,4]],
	/*PERK GONE [236,"bringing home the bacon","unique","Carrying a Victim highlights Leatherface to all Family members for 45 seconds.",[2,4]],*/
	...
	[235,"bloodlust","unique","Leatherface does 40% more damage after executing a Victim at the gallows.",[2,5]],
	[240,"patience","unique","Standing still will recharge Johnny’s ability slowly and clues left by Victims can be analyzed 50% faster.",[4,5]],
	...
	[245,"spore loser","unique","Losing a close encounter automatically drops an emergency poison cloud, even if you're out of powder. Cooldown is 20 seconds.",[4,6]],
	...
	[248,"sip sip sip","blood-harvest","Melee attacks give 100% more blood in your vial, but attack damage is reduced by 20%.",[6,0]],
	...
	[252,"barrier breaker","unique","The perk holder can break obstacles. Higher levels allow them to break the obstacle 40% quicker.",[9,3]],
	[253,"short fuse","unique","When a Victim is shocked by an electric trap, that Victim is highlighted to the perk holder for 35 seconds.",[2,6]],
	[254,"bruiser","unique","Victims hit by defensive barge take an additional 25 points of damage.",[3,4]],
	[255,"rip stalled","unique","After using the ripstall ability on an object, the object cannot be interacted with again by anyone for 40 more seconds.",[8,5]],
	[256,"hands off","unique","You are immune to close encounters. But overall speed is reduced by 10%.",[1,4]],
	[257,"slow hands","unique","Victims that trigger an electric trap complete hold and tap interactions 80% slower for 20 seconds.",[3,6]],
	[258,"ding dong","unique","The bell attached to strands of barbed wire will ring 150% louder, and its highlight range will be increased by 100%.",[4,4]],
	[259,"give me more","unique","Nancy's ability regeneration rate is increased by 40% but stamina regeneration is reduced by 10%.",[6,4]],
	[260,"hey sissy","unique","Ability cooldown rate is removed, but ingesting Sissy's powder causes 10 seconds of blurry vision the next time your ability is used.",[8,4]],
	...
	[262,"i'll kill them all","unique","After using her ability, Nancy's damage is increased by 20% for 45 seconds.",[0,5]],
	...
	[268,"heart attack","unique","A Victim's bleed out is increased by 180 seconds if they trigger an electric trap or are hit by barge. Total bleed out inflicted is 30HP.",[7,4]],
	...
	[272,"resourceful engineer","unique","Bones can create a gore bomb directly on the site of a detonated bomb. Consumes 20% of the blood remaining in his blood vial. This cannot be used if the blood vial is empty.",[2,7]],
	...
	/*grandpa abilities*/
	[600,"always in sync","grandpa","When active, Family Focus duration is doubled and its cooldown is reduced by 66%. All Family members receive an additional 15 seconds of stun immunity beyond the base duration.",[0,0]],
	[601,"animal farm",'grandpa',"Increases chicken detection radius.",[1,0]],
	[602,"thousand cuts",'grandpa',"Victim bleed out rate Increased by 400%. Does not apply on the last Victim.",[2,0]],
	[603,"brute strength",'grandpa',"Slightly increases melee damage for all Family members.",[3,0]],
	[604,"don't have all day",'grandpa',"Stamina drain while sprinting is decreased by 35%.",[4,0]],
	...
	[609,"suffocating grip",'grandpa',"Close encounter minigame is easier by 20% for all Family members.",[4,1]],
	[610,"swinging for the fences",'grandpa',"Reduces stamina consumption on melee atacks by 30%.",[0,2]],
	[611,"well fed young'uns",'grandpa',"Whenever Grandpa's Sonar is activated, all Family members instantly regain 50 stamina.",[1,2]],
	[612,"well well well",'grandpa',"Victims that jump down wells and windows take 50% more damage.",[2,2]],
	[613,"trespassers tax",'grandpa',"The minigame for gathering items, opening crawlspaces and turning on the valve is 50% more difficult for all Victims.",[3,2]],

	[999,"study and tamper","ability","Work in progress.",[0,0]],
		/*character trees: connie*/
	[700,"focused","ability","Reduces the ability recharge time to 240 seconds.",[0,0]],
	[701,"focused","ability","There is no stamina cost when activating your ability.",[1,0]],
	[702,"focused","ability","Once activated, stamina and Family proximity debuff is 15 seconds.",[2,0]],
	[703,"focused","ability","Reduces the ability recharge time to 260 seconds.",[3,0]],
	[704,"focused","ability","Stamina consumed while activating Focused ability is reduced by 35%. Does not stack.",[4,0]],
	[705,"focused","ability","Once activated, stamina and Family proximity debuff is 18 seconds.",[0,1]],
	[706,"focused","ability","Reduces the ability recharge time to 280 seconds.",[1,1]],
	[707,"focused","ability","Stamina consumed while activating Focused ability is reduced by 15%. Does not stack.",[2,1]],
	[708,"focused","ability","Once activated, stamina and Family proximity debuff is 20 seconds.",[0,3]],

			/*character trees: julie*/
	[709,"ultimate escape","ability","Reduces the ability recharge duration to 90 seconds.",[0,0]],
	[710,"ultimate escape","ability","Running speed is increased by 5%.",[1,0]],
	[711,"ultimate escape","ability","Ability lasts for 25 seconds.",[2,0]],
	[712,"ultimate escape","ability","Reduces the ability recharge duration to 100 seconds.",[3,0]],
	[713,"ultimate escape","ability","Running stamina consumption is reduced by 100% while ability is active.",[4,0]],
	[714,"ultimate escape","ability","Ability lasts for 20 seconds.",[0,1]],
	[715,"ultimate escape","ability","Reduces the ability recharge duration to 110 seconds.",[1,1]],
	[716,"ultimate escape","ability","Running stamina consumption is reduced by 75% while ability is active.",[2,1]],
	[717,"ultimate escape","ability","Ability lasts for 15 seconds.",[0,3]],

				/*character trees: maria*/
	[718,"sweet talk","ability","Grandpa highlights Family members on the next 2 sonars.",[0,0]],
	[719,"sweet talk","ability","Grandpa highlights Family members in close proximity to him.",[1,0]],
	[720,"sweet talk","ability","Sweet-talking Grandpa reduces Family bond by 1 level. Ability cooldown increased.",[2,0]],
	[721,"sweet talk","ability","The cooldown time between uses of your Sweet Talk ability is reduced by 40%.",[3,0]],
	[722,"sweet talk","ability","Decrease the time it takes to sweet-talk Grandpa to 2 seconds.",[4,0]],
	[723,"sweet talk","ability","Cooldown delay reduced by 2 second(s).",[0,1]],
	[724,"sweet talk","ability","Cooldown delay reduced by 1 second(s).",[1,1]],
	[725,"sweet talk","ability","The duration of time that Grandpa is highlighted is increased to 15 seconds",[2,1]],
	[726,"sweet talk","ability","The cooldown time between uses of your Sweet Talk ability is reduced by 20%.",[0,3]],

	[727,"life saver","ability","Time taken to recharge ability is set to 180 seconds.",[0,0]],
	[728,"life saver","ability","Applies a concussion effect to the knocked down Family member.",[1,0]],
	[729,"life saver","ability","Barged Family members will be stunned for 8 seconds.",[2,0]],
	[730,"life saver","ability","Time taken to recharge ability is set to 200 seconds.",[3,0]],
	[731,"life saver","ability","After barging a Family member, 60 stamina is restored.",[4,0]],
	[732,"life saver","ability","Barged Family members will be stunned for 7 seconds.",[0,1]],
	[733,"life saver","ability","Time taken to recharge ability is set to 220 seconds.",[1,1]],
	[734,"life saver","ability","After barging a Family member, 30 stamina is restored.",[2,1]],
	[735,"life saver","ability","Barged Family members will be stunned for 6 seconds.",[0,3]],

	[736,"pain is nothing","ability","Reduces the ability recharge rate to 135 seconds.",[0,0]],
	[737,"pain is nothing","ability","Your damage reduction multiplier is set to 80%.",[1,0]],
	[738,"pain is nothing","ability","Ability lasts for 11 seconds.",[2,0]],
	[739,"pain is nothing","ability","Reduces the ability recharge rate to 153 seconds.",[3,0]],
	[740,"pain is nothing","ability","While active, incoming melee attacks will restore small amounts of stamina.",[4,0]],
	[741,"pain is nothing","ability","Ability lasts for 10 seconds.",[0,1]],
	[742,"pain is nothing","ability","Reduces the ability recharge rate to 162 seconds.",[1,1]],
	[743,"pain is nothing","ability","Your damage reduction multiplier is set to 70%.",[2,1]],
	[744,"pain is nothing","ability","Ability lasts for 9 seconds.",[0,3]],

	[745,"study and tamper","ability","You can instantly study objects with a tap of a button. However, using Instant Study on the Fusebox, Generator, Car Battery, or Valve removes the ability to tamper that object.",[0,0]],
	[746,"study and tamper","ability","Objects that can be studied or tampered with are permanently highlighted when approached. The range is also increased.",[1,0]],
	[747,"study and tamper","ability","While tampering with objects, both you and the object are highlighted to all Victims.",[2,0]],
	[748,"study and tamper","ability","Time taken to study objects is reduced by 40%.",[3,0]],
	[749,"study and tamper","ability","Knowledge gathered from studying objects is increased by 60%. Does not stack.",[4,0]],
	[750,"study and tamper","ability","Tampering minigame target is reduced by 12%. Does not stack.",[0,1]],
	[751,"study and tamper","ability","Time taken to study objects is reduced by 30%.",[1,1]],
	[752,"study and tamper","ability","Knowledge gathered from studying objects is increased by 30%. Does not stack.",[2,1]],
	[753,"study and tamper","ability","Tampering minigame target is reduced by 6%. Does not stack.",[0,3]],

	[754,"boon","ability","Powder Cloud consumes Family stamina when inside the cloud.",[0,0]],
	[755,"boon","ability","Powder Cloud heals Victims 3 points per second while inside cloud.",[1,0]],
	[756,"boon","ability","Powder Cloud Reduces blood vial amount to 0.",[2,0]],
	[757,"boon","ability","Ability Cooldown Reduction by 40%",[3,0]],
	[758,"boon","ability","Increase duration of powder cloud by 5 seconds.",[4,0]],
	[759,"boon","ability","Increase duration of contamination of blood buckets by 30 seconds.",[0,1]],
	[760,"boon","ability","Increase duration of contamination of blood buckets by 10 seconds.",[1,1]],
	[761,"boon","ability","You can now contaminate 10 buckets instead of 4 per fully ability charge.",[2,1]],
	...
	[768,"knife throw","ability","Family members hit by throwing knives have their stamina reduced to 0.",[0,1]],
	[769,"knife throw","ability","The number of throwing knives you start off with is increased by 1.",[1,1]],
	[770,"knife throw","ability","The time to unsheathe your throwing knife is reduced by an additional 1 second(s). Unsheathe Time Duration Stacks.",[2,1]],
	[771,"knife throw","ability","The number of throwing knives you start off with is increased by 1.",[0,3]],

	[772,"maim","ability","Reduces the chances of overheat from excessive revving by 10%.",[0,0]],
	[773,"maim","ability","The chainsaw can be used more often before stalling by 10%.",[1,0]],
	[774,"maim","ability","Reduces the overheat cooldown time before you can restart the chainsaw by 15%",[2,0]],
	[775,"maim","ability","Reduces the chances of overheat from excessive revving by 20%.",[3,0]],
	[776,"maim","ability","The chainsaw can be used more often before stalling by 20%.",[4,0]],
	[777,"maim","ability","Reduces the overheat cooldown time before you can restart the chainsaw by 25%.",[0,1]],
	[778,"maim","ability","Reduces the chances of overheat from excessive revving by 30%.",[1,1]],
	[779,"maim","ability","Starts the chainsaw instantly.",[2,1]],
	[780,"maim","ability","Reduces the overheat cooldown time before you can restart the chainsaw by 35%.",[0,3]],

	[781,"seek","ability","Reduces ability drain by 30%.",[0,0]],
	[782,"seek","ability","Victim detection range increased by 10%.",[1,0]],
	[783,"seek","ability","Increases ability bar recharge rate by 33%",[2,0]],
	[784,"seek","ability","Reduces ability drain by 60%.",[3,0]],
	[785,"seek","ability","Victim detection range increased by 20%.",[4,0]],
	[786,"seek","ability","Increases ability bar recharge rate by 60%",[0,1]],
	...
	[800,"bane","ability","Poison can now be applied to bone scrap piles, toolboxes, generators and car batteries.",[2,0]],
	[801,"bane","ability","Increases poison cloud duration to 55 seconds",[3,0]],
	[802,"bane","ability","Increases the amount of time a Victim is affected by poison to 13.5 seconds.",[4,0]],
	[803,"bane","ability","Reduce the time to create poison at mortar and pestle tables to 2 seconds.",[0,1]],
	[804,"bane","ability","Increases poison cloud duration to 50 seconds.",[1,1]],
	[805,"bane","ability","Increases the amount of time a Victim is affected by poison to 12 seconds.",[2,1]],
	[806,"bane","ability","Reduce the time to create poison at mortar and pestle tables to 3 seconds.",[0,3]],

	[807,"ripstall","ability","Ripstalling increases melee damage by 10% for 30 seconds.",[0,0]],
	[808,"ripstall","ability","Defensive Barge does 50% more damage",[1,0]],
	[809,"ripstall","ability","After performing a Ripstall, the object will gain a instant electric trap. This has 1 charge(s)",[2,0]],
	[810,"ripstall","ability","Ripstall cooldown reduction by 30%",[3,0]],
	[811,"ripstall","ability","Defensive barge stamina cost reduced by 20%",[4,0]],
	[812,"ripstall","ability","Time it takes to set Electric trap reduced by 20%",[0,1]],
	[813,"ripstall","ability","Time it takes to set Electric trap reduced by 10%",[1,1]],
	[814,"ripstall","ability","Defensive barge stamina cost reduced by 10%",[2,1]],
	[815,"ripstall","ability","Ripstall cooldown reduction by 20%",[0,3]],

	[816,"hunt","ability","Consumption rate for footprint tracking reduced by 7%.",[0,0]],
	[817,"hunt","ability","Increases the detection range of clues left by Victims by 15%.",[1,0]],
	[818,"hunt","ability","Increases ability bar recharge rate by 14%.",[2,0]],
	[819,"hunt","ability","Consumption rate for footprint tracking reduced by 21%.",[3,0]],
	[820,"hunt","ability","Increases the detection range of clues left by Victims by 30%.",[4,0]],
	[821,"hunt","ability","Increases ability bar recharge rate by 34%.",[0,1]],
	[822,"hunt","ability","Changes the color of footprints based on how recently they were left.",[2,1]],
	[823,"hunt","ability","Increases the range of footprint trails by 100%.",[0,3]],

	[824,"spy","ability","Always Spy on the Victim closest to you. 	While using your Spy ability, your vision is much clearer.",[0,0]],
	[825,"spy","ability","Always Spy on the Victim furthest from you. 	While using your Spy ability, your vision is much clearer.",[1,0]],
	[826,"spy","ability","	While using your Spy ability, your vision is much clearer.",[2,0]],
	[827,"spy","ability","Increases the amount of time your Spy ability is active by 55%. Does not stack.",[3,0]],
	[828,"spy","ability","Increases the rate your ability bar recharges by 40%. Does not stack.",[4,0]],
	[829,"spy","ability","Reduces recharge time between ability uses by 6 seconds.",[0,1]],
	[830,"spy","ability","Increases the amount of time your Spy ability is active by 40%. Does not stack.",[1,1]],
	[831,"spy","ability","Increases the rate your ability bar recharges by 20%. Does not stack.",[2,1]],
	[832,"spy","ability","Reduces recharge time between ability uses by 3 seconds.",[0,3]],

	[833,"gore bomb","ability","Retrieving a spark plug from a detonated gore bomb also fills the blood vial.",[0,0]],
	[834,"gore bomb","ability","When a Victim is hit by a gore bomb, Bones becomes thrilled for 45 seconds, his stamina consumption is reduced by 50%, and his damage dealt is increased by either 25% or 50% against Victims hit by the gore bomb.",[1,0]],
	[835,"gore bomb","ability","Start with 1 additional gore bomb.",[2,0]],
	[836,"gore bomb","ability","Use a toolbox to turn an unmodified gore bomb into a fragmentation bomb, boosting damage by 50%.",[3,0]],
	[837,"gore bomb","ability","Victims hit by a gore bomb lose all of their stamina for a brief period of time.",[4,0]],
	[838,"gore bomb","ability","Victims hit by a gore bomb stay revealed for an extra 30 seconds.",[0,1]],
	[839,"gore bomb","ability","Victims hit by a gore bomb are revealed to the entire Family, not just to Bones.",[1,1]],
	[840,"gore bomb","ability","Gore bombs can be made from empty or full blood buckets without using blood.",[2,1]],
	[841,"gore bomb","ability","Gore bomb damage is increased by 20%.",[0,3]],

	[842,"heightened sense","ability","Increases noise detection range of the ability by 35%.",[0,0]],
	[843,"heightened sense","ability","Lets the player identify if a noise was made by another Victim or Family member.",[1,0]],
	[844,"heightened sense","ability","Increases Ability Recharge Rate by 100%. Does Not Stack",[2,0]],
	[845,"heightened sense","ability","Increases noise detection range of the ability by 25%.",[3,0]],
	[846,"heightened sense","ability","	Cooldown before your ability starts recharging is reduced by 2s.",[4,0]],
	[847,"heightened sense","ability","Reduces the consumption rate of the ability by 50%.",[0,1]],
